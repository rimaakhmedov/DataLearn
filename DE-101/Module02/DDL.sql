...
(
 ...
 CONSTRAINT PK_128 PRIMARY KEY ( order_date )
);

-- ************************************** "Ship Date"

CREATE TABLE "ship date"
(
 ...
 week      int NOT NULL,
 week_day  int NOT NULL,
 CONSTRAINT PK_160 PRIMARY KEY ( ship_date )
);
...
(
 ...
 CONSTRAINT FK_117 FOREIGN KEY ( order_date ) REFERENCES "order date" ( order_date ),
 ...
 CONSTRAINT FK_166 FOREIGN KEY ( ship_date ) REFERENCES "ship date" ( ship_date )
);
